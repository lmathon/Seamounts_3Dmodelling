...
save(hierarchical_results, file="05_Marine_Spatial_Planning/03_Prioritization/Prioritization30/Rdata/hierarchical_results30.rdata")
...
save(topsis_results, file="05_Marine_Spatial_Planning/03_Prioritization/Prioritization30/Rdata/topsis_results30.rdata")         
write.csv(topsis_results, "05_Marine_Spatial_Planning/03_Prioritization/Prioritization30/Rdata/topsis_results30.csv", row.names = FALSE)
...
ggsave(result_plot, file="05_Marine_Spatial_Planning/03_Prioritization/Prioritization30/result_plot30.png")
save(result_plot, file="05_Marine_Spatial_Planning/03_Prioritization/Prioritization30/Rdata/result_plot30.rdata")
