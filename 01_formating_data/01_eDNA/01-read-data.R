...
# Source functions
source("01_formating_data/01_eDNA/00_functions.R")
load("01_formating_data/01_eDNA/Rdata/archive_class_ncbi.Rdata")

# List the directories 
list_projects_dir <- list.dirs(path = "01_formating_data/01_eDNA/Data_MOTUs", full.names = TRUE, recursive = F)
...
for(i in 1:length(list_projects_dir)){
 ...
 save(list_read_step1, list_clean_lot_discarded, file = "01_formating_data/01_eDNA/Rdata/all_df_step1.Rdata")
...
save(archive_class_ncbi, file = "01_formating_data/01_eDNA/Rdata/archive_class_ncbi.Rdata")

# Save data
save(list_read_step1, list_clean_lot_discarded, list_read_step2, file = "01_formating_data/01_eDNA/Rdata/01_read_data.Rdata")
