...
# Load data
load("01_formating_data/01_eDNA/Rdata/01_read_data.Rdata")
...
# Set the path 
path_lulu <- "01_formating_data/01_eDNA/LULU/"
...
save(list_read_step3, list_read_step3_0PCR, list_read_step4, df_all_filters, file = "01_formating_data/01_eDNA/Rdata/02-clean-data.Rdata")
