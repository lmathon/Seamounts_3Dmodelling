...
# Load data
load("Scripts_R/Rdata/01_read_data.Rdata")
...
metadata_field <- read.csv("metadata_all.csv", sep=";", stringsAsFactors = F)
...
save(list_read_step3, list_read_step3_0PCR, list_read_step4, df_all_filters, file = "Scripts_R/Rdata/02-clean-data.Rdata")
