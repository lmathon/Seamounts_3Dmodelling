...
############ Crypthelia 
# read extent
Crypthelia_Extent=extent(168.18,168.31,-23.39,-23.19)
...
metaDna$DepthMNT=round(extract(Crypthelia_Depth,xy))*(-1)
metaDna[metaDna$Site_name=="Crypthelia",] #### les prof sommets sont ok, et les profs pelagique aussi

Crypthelia_SummitDepth=round(max(values(Crypthelia_Depth),na.rm=TRUE))
Crypthelia_BottomDepth=round(min(values(Crypthelia_Depth),na.rm=TRUE))
Crypthelia_Height=Crypthelia_SummitDepth-Crypthelia_BottomDepth
Crypthelia_SummitDepth
Crypthelia_BottomDepth
Crypthelia_Height   ###### la prof du sommet semble correcte, la campagne de terrain indiquant un mont au sommet plat a environ 201 m de fond. Nos 10 mesure edna range entre 201 et 236 m
#aucune correction necessaire
#values(Crypthelia_Depth)[values(Crypthelia_Depth) > -300] = round(runif(1000,299,313),digit=4)*(-1)   ### correction des valeurs de profondeur inferieures à 300m
...
Crypthelia_SummitArea=area(Crypthelia_Summit_Poly)*1e-6
Crypthelia_SummitArea
plot(Crypthelia_Depth)
contour(Crypthelia_Depth,add=TRUE)
...
values(Crypthelia_Slope_Poly)[values(Crypthelia_Slope_Poly) > Crypthelia_SummitDepth+30/100*Crypthelia_SummitDepth | values(Crypthelia_Slope_Poly) < Crypthelia_BottomDepth-30/100*Crypthelia_BottomDepth] = NA
...
########     Crypthelia NIGHT SLOPE ACOUSTIC
plot(Crypthelia_Depth)
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_Night[[2]],Crypthelia_Slope_Poly),add=TRUE)

Acoustic_Night_Crypthelia_Slope=as.data.frame(mask(Acoustic_stack_Night,Crypthelia_Slope_Poly),xy=TRUE)
Acoustic_Night_Crypthelia_Slope=Acoustic_Night_Crypthelia_Slope[rowSums(is.na(Acoustic_Night_Crypthelia_Slope)) != ncol(Acoustic_Night_Crypthelia_Slope)-2,]
Acoustic_Night_Crypthelia_Slope$Site="Crypthelia"
Acoustic_Night_Crypthelia_Slope$Day="Night"
Acoustic_Night_Crypthelia_Slope$Habitat="Slope"

#View(Acoustic_Night_Crypthelia_Slope)
head(Acoustic_Night_Crypthelia_Slope)
#############


########     Crypthelia NIGHT SUMMIT ACOUSTIC
plot(Crypthelia_Depth)
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_Night[[2]],Crypthelia_Summit_Poly),add=TRUE)

Acoustic_Night_Crypthelia_Summit=as.data.frame(mask(Acoustic_stack_Night,Crypthelia_Summit_Poly),xy=TRUE)
Acoustic_Night_Crypthelia_Summit=Acoustic_Night_Crypthelia_Summit[rowSums(is.na(Acoustic_Night_Crypthelia_Summit)) != ncol(Acoustic_Night_Crypthelia_Summit)-2,]
Acoustic_Night_Crypthelia_Summit$Site="Crypthelia"
Acoustic_Night_Crypthelia_Summit$Day="Night"
Acoustic_Night_Crypthelia_Summit$Habitat="Summit"

#View(Acoustic_Night_Crypthelia_Summit)
head(Acoustic_Night_Crypthelia_Summit)
#############

########     Crypthelia DAY SLOPE ACOUSTIC
plot(Crypthelia_Depth)
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_day[[2]],Crypthelia_Slope_Poly),add=TRUE)

Acoustic_Day_Crypthelia_Slope=as.data.frame(mask(Acoustic_stack_day,Crypthelia_Slope_Poly),xy=TRUE)
Acoustic_Day_Crypthelia_Slope=Acoustic_Day_Crypthelia_Slope[rowSums(is.na(Acoustic_Day_Crypthelia_Slope)) != ncol(Acoustic_Day_Crypthelia_Slope)-2,]
Acoustic_Day_Crypthelia_Slope$Site="Crypthelia"
Acoustic_Day_Crypthelia_Slope$Day="Day"
Acoustic_Day_Crypthelia_Slope$Habitat="Slope"

#View(Acoustic_Day_Crypthelia_Slope)
head(Acoustic_Day_Crypthelia_Slope)
#############

########     Crypthelia DAY SUMMIT ACOUSTIC
plot(Crypthelia_Depth)
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_day[[2]],Crypthelia_Summit_Poly),add=TRUE)

Acoustic_Day_Crypthelia_Summit=as.data.frame(mask(Acoustic_stack_day,Crypthelia_Summit_Poly),xy=TRUE)
Acoustic_Day_Crypthelia_Summit=Acoustic_Day_Crypthelia_Summit[rowSums(is.na(Acoustic_Day_Crypthelia_Summit)) != ncol(Acoustic_Day_Crypthelia_Summit)-2,]
Acoustic_Day_Crypthelia_Summit$Site="Crypthelia"
Acoustic_Day_Crypthelia_Summit$Day="Day"
Acoustic_Day_Crypthelia_Summit$Habitat="Summit"

#View(Acoustic_Day_Crypthelia_Summit)
head(Acoustic_Day_Crypthelia_Summit)
...
Crypthelia_Acoustic=rbind(Acoustic_Night_Crypthelia_Slope,Acoustic_Night_Crypthelia_Summit,Acoustic_Day_Crypthelia_Slope,Acoustic_Day_Crypthelia_Summit)

#add bathymetric data
Crypthelia_Acoustic$SummitDepth=Crypthelia_SummitDepth*(-1)
Crypthelia_Acoustic$ValleyDepth=Crypthelia_BottomDepth*(-1)
Crypthelia_Acoustic$Height=Crypthelia_Height
Crypthelia_Acoustic$SummitAreasKm2=Crypthelia_SummitArea
Crypthelia_Acoustic$SummitRugosity=Crypthelia_SummitRugosity
Crypthelia_Acoustic$BottomDepth=extract(Crypthelia_Depth,Crypthelia_Acoustic[c(1,2)])*(-1)
View(Crypthelia_Acoustic)
head(Crypthelia_Acoustic)

# correct bad bottom depth for depth smaller than 800 m (maximum measured by EK60)
#head(Crypthelia_Acoustic)
#cbind(names(Crypthelia_Acoustic))

Crypthelia_Acoustic2=Crypthelia_Acoustic[,c(3:81)]
#cbind(names(Crypthelia_Acoustic2))
head(Crypthelia_Acoustic2)

# affecte une profondeur lorsque mesurable par EK60
for (i in 1:nrow(Crypthelia_Acoustic2)) {
  for (p in 1:ncol(Crypthelia_Acoustic2)) {
    if (sum(Crypthelia_Acoustic2[i,c(p:79)],na.rm = TRUE)==0) {
      Crypthelia_Acoustic$BottomDepth[i]=(p-1)*10
      break
    } 
  }
}
...
for (i in 1:nrow(Crypthelia_Acoustic2)) {
    if (Crypthelia_Acoustic2[i,79]!="NaN" & Crypthelia_Acoustic$BottomDepth[i]<790) {
      Crypthelia_Acoustic$BottomDepth[i]=mean(Crypthelia_Acoustic$BottomDepth[Crypthelia_Acoustic$BottomDepth > 790])
      next
  }
}
...
Crypthelia_Acoustic$Habitat[Crypthelia_Acoustic$BottomDepth<=(Crypthelia_SummitDepth+30/100*Crypthelia_SummitDepth)*(-1)]="Summit"
Crypthelia_Acoustic$Habitat[Crypthelia_Acoustic$BottomDepth>(Crypthelia_SummitDepth+30/100*Crypthelia_SummitDepth)*(-1) &  
                      Crypthelia_Acoustic$BottomDepth<=(Crypthelia_BottomDepth-30/100*Crypthelia_BottomDepth)*(-1)]="Slope"

# verifie qu'il n'y a aucune profondeur superieure a la limite infeieure de la pente
Crypthelia_Acoustic[Crypthelia_Acoustic$BottomDepth>(Crypthelia_BottomDepth-30/100*Crypthelia_BottomDepth)*(-1),]

#sample size for analysis at site
table(Crypthelia_Acoustic$Habitat,Crypthelia_Acoustic$Day)

# raster layer of surface acoustic data at site
Crypthelia_Acoustic_Surface_raster=rasterFromXYZ(cbind(Crypthelia_Acoustic$x,Crypthelia_Acoustic$y,Crypthelia_Acoustic$Depth_10),crs = "+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0")
Crypthelia_Acoustic_RealSummit_Surface_raster=rasterFromXYZ(cbind(Crypthelia_Acoustic$x[Crypthelia_Acoustic$Habitat=="Summit"],Crypthelia_Acoustic$y[Crypthelia_Acoustic$Habitat=="Summit"],Crypthelia_Acoustic$Depth_10[Crypthelia_Acoustic$Habitat=="Summit"]),crs = "+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0")
Crypthelia_Acoustic_RealSlope_Surface_raster=rasterFromXYZ(cbind(Crypthelia_Acoustic$x[Crypthelia_Acoustic$Habitat=="Slope"],Crypthelia_Acoustic$y[Crypthelia_Acoustic$Habitat=="Slope"],Crypthelia_Acoustic$Depth_10[Crypthelia_Acoustic$Habitat=="Slope"]),crs = "+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0")



# add environmental data
head(Crypthelia_Acoustic)
names(Crypthelia_Acoustic)
Crypthelia_Acoustic$SSTmean1k=extract(SSTmean1k,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$SSTmin1k=extract(SSTmin1k,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$SSTmax1k=extract(SSTmax1k,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$SSTsd1k=extract(SSTsd1k,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$ChlorA=extract(ChlorA,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$EastwardVelocity=extract(EastwardVelocity,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$NorthwardVelocity=extract(NorthwardVelocity,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$Salinity=extract(Salinity,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$SeaFloorPotentialTemperature=extract(SeaFloorPotentialTemperature,Crypthelia_Acoustic[c(1,2)])
Crypthelia_Acoustic$SuspendedParticulateMatter=extract(SuspendedParticulateMatter,Crypthelia_Acoustic[c(1,2)])

Crypthelia_pnts=Crypthelia_Acoustic[,c(1,2)]
dist.Reef = geosphere::dist2Line(Crypthelia_pnts, Reef)
dist.Land = geosphere::dist2Line(Crypthelia_pnts, Land)
Crypthelia_Acoustic$ShortestDistanceReef=dist.Reef[,1]
Crypthelia_Acoustic$ShortestDistanceLand=dist.Land[,1]
...
#surface 0-20m
Crypthelia_Acoustic$AcousticSurface=rowMeans(Crypthelia_Acoustic[,c(3:4)],na.rm = TRUE)
...
Crypthelia_Acoustic2=Crypthelia_Acoustic[,c(3:81)]
Crypthelia_Acoustic$AcousticFond="NaN"
...
for (i in 1:nrow(Crypthelia_Acoustic2)) {
  for (p in 1:ncol(Crypthelia_Acoustic2)) {
    k=p-2+2
    l=p-1+2
    if (sum(Crypthelia_Acoustic2[i,c(p:79)],na.rm = TRUE)==0 & k==2) {
      Crypthelia_Acoustic$AcousticFond[i]=Crypthelia_Acoustic[i,l]
    }else if (sum(Crypthelia_Acoustic2[i,c(p:79)],na.rm = TRUE)==0 & k!=2) {
      Crypthelia_Acoustic$AcousticFond[i]=rowMeans(Crypthelia_Acoustic[i,c(k:l)],na.rm = TRUE)
      break
    }
  }
}
...
names(Crypthelia_Acoustic)
head(Crypthelia_Acoustic)
unique(Crypthelia_Acoustic$Habitat)
unique(Crypthelia_Acoustic$Day)
range(as.numeric(Crypthelia_Acoustic$AcousticFond),na.rm=TRUE)
range(as.numeric(Crypthelia_Acoustic$AcousticSurface),na.rm=TRUE)
table(Crypthelia_Acoustic$Day,Crypthelia_Acoustic$Habitat)
View(Crypthelia_Acoustic)
...
#export directory
dir.exists("Crypthelia_Output")
dir.create("Crypthelia_Output")

write_xlsx(list(Crypthelia = Crypthelia_Acoustic),path="Crypthelia_Output/Crypthelia_Acoustic_Data.xlsx")
writeRaster(Crypthelia_Depth, filename="Crypthelia_Output/Crypthelia_Depth.tif", format="GTiff", overwrite=TRUE)
writeRaster(Crypthelia_Acoustic_Surface_raster, filename="Crypthelia_Output/Crypthelia_Acoustic_Surface_raster.tif", format="GTiff", overwrite=TRUE)

path=getwd()
setwd(paste(path,"/Crypthelia_Output",sep=""))
getwd()
writeOGR(Crypthelia_Slope_Poly, dsn = '.', layer = 'Crypthelia_Slope_Poly', driver = "ESRI Shapefile")
writeOGR(Crypthelia_Summit_Poly, dsn = '.', layer = 'Crypthelia_Summit_Poly', driver = "ESRI Shapefile")

setwd(path)
getwd()

###### Plot data without showing error in depth summit/slope
plot(Crypthelia_Depth,main="Crypthelia")
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Acoustic_Surface_raster,col="lavender",add=TRUE,legend=FALSE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)

dev.print(device = png, file = "Crypthelia_Output/Crypthelia_Map_Acoustic.png", width = 600)
...
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(Crypthelia_Acoustic_RealSummit_Surface_raster,col="magenta",add=TRUE,legend=FALSE)
plot(Crypthelia_Acoustic_RealSlope_Surface_raster,col="blue",add=TRUE,legend=FALSE)

dev.print(device = png, file = "Crypthelia_Output/Crypthelia_Map_Acoustic_RealSlopeSummit.png", width = 600)
...
##########MULTIPLOT
par(mfrow=c(2,2))
plot(Crypthelia_Depth,main="Night SLope")
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_Night[[2]],Crypthelia_Slope_Poly),add=TRUE)

plot(Crypthelia_Depth,main="Night Summit")
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_Night[[2]],Crypthelia_Summit_Poly),add=TRUE)
...
plot(Crypthelia_Depth, main= "Day Slope")
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_day[[2]],Crypthelia_Slope_Poly),add=TRUE)

plot(Crypthelia_Depth, main = "Day Summit")
contour(Crypthelia_Depth,add=TRUE)
plot(Crypthelia_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Crypthelia_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_day[[2]],Crypthelia_Summit_Poly),add=TRUE)
