...
load("01_formating_data/02_BRUVs/Rdata/bruvs_abundance_all.rdata")

#------------------------------------------------------------------------------------------
# On all species abundance
#------------------------------------------------------------------------------------------

summary(bruvs_abundance_all)
bruvs_abundance_all$Habitat <- as.factor(bruvs_abundance_all$Habitat)
bruvs_abundance_all$Site <- as.factor(bruvs_abundance_all$Site)


###
names(bruvs_abundance_all)
glm.variables= glm(abundance_tot ~ Habitat+EastwardVelocity+NorthwardVelocity+Salinity+
                     ...
                     Vegetation+Bare+HabitatDiversity+Depth, family=poisson, data=bruvs_abundance_all)
...
glm.variables= glm(abundance_tot ~ Habitat+EastwardVelocity+NorthwardVelocity+Salinity+
                     SuspendedParticulateMatter+SSTmax+SSTmean+SSTmin+seafloorTemp+Chla+
                     ReefMinDist.m+LandMinDist.m+SummitDepth+Height+SummitAreasKm2+SummitRugosity+
                     Complex+Reef.structure+Rocks+Rubbles+Gravel+Sand+Indeterm+Coral+Filter_feeders+
                     Vegetation+Bare+HabitatDiversity+Depth, family=poisson, data=bruvs_abundance_all)
anova(glm.variables)
summary(glm.variables) 
...
ggplot(bruvs_abundance_all, aes(Site, abundance_tot)) + 
...
ggplot(bruvs_abundance_all, aes(Habitat, abundance_tot)) + 
  geom_jitter(colour="lightgrey") + 
  geom_boxplot(outlier.shape=NA, fill=NA)  +
  theme(panel.background=element_rect(fill=NA, color="black")) +
...
ggplot(aes(y = abundance_tot, x = Site, fill = Habitat), data = bruvs_abundance_all) +
  geom_jitter(colour="lightgrey") +
...
anova.habitat= aov(abundance_tot ~ Habitat, data=bruvs_abundance_all) 
summary(anova.habitat) 

## anova a 2 facteurs

anova.Site.habitat= aov(abundance_tot ~ Site*Habitat, data=bruvs_abundance_all) 
...
##
glm.Site.habitat= glm(abundance_tot ~ Site+Habitat, family=gaussian, data=bruvs_abundance_all)
...
##
glm.Site.habitat.profondeur= glm(abundance_tot ~ Site+Habitat+Depth, family=gaussian, data=bruvs_abundance_all)
...
glm.variables= glm(Logabundance_tot ~ Habitat+EastwardVelocity+NorthwardVelocity+Salinity+
                     ...
                     TravelTime+ReefMinDist.m+LandMinDist.m+SummitDepth+Height+SummitAreasKm2+SummitRugosity+
                     Topo+Complex+Reef.structure+Rocks+Rubbles+Gravel+Sand+Mud+Indeterm+Coral+Filter_feeders+
                     Vegetation+Bare+HabitatDiversity+Depth, family=gaussian, data=bruvs_abundance_all)
...
ggplot(bruvs_abundance_all, aes(Site, Logabundance_tot)) + 
  geom_jitter(colour="lightgrey") + 
  geom_boxplot(outlier.shape=NA, fill=NA)  +
  theme(panel.background=element_rect(fill=NA, color="black")) +
  xlab("Site") + ylab("abundance")+
...
ggplot(bruvs_abundance_all, aes(Habitat, Logabundance_tot)) + 
  geom_jitter(colour="lightgrey") + 
  geom_boxplot(outlier.shape=NA, fill=NA)  +
  theme(panel.background=element_rect(fill=NA, color="black")) +
  xlab("Habitat") + ylab("abundance")+
...
ggplot(aes(y = Logabundance_tot, x = Site, fill = Habitat), data = bruvs_abundance_all) +
  geom_jitter(colour="lightgrey") +
  geom_boxplot(outlier.shape=NA) +
  theme(panel.background=element_rect(fill=NA, color="black")) +
  xlab("Site") + ylab("abundance") +
...
anova.habitat= aov(Logabundance_tot ~ Habitat, data=bruvs_abundance_all) 
summary(anova.habitat) 

## anova a 2 facteurs

anova.Site.habitat= aov(Logabundance_tot ~ Site*Habitat, data=bruvs_abundance_all) 
summary(anova.Site.habitat) 
...
##
glm.Site.habitat= glm(Logabundance_tot ~ Site+Habitat, family=gaussian, data=bruvs_abundance_all)
...
##
glm.Site.habitat.profondeur= glm(Logabundance_tot ~ Site+Habitat+Depth, family=gaussian, data=bruvs_abundance_all)
