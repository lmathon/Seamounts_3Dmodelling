...
############ Nepoui 
# read extent
Nepoui_Extent=extent(164.8,165.15,-21.6,-21.25)
Nepoui_Depth=crop(Bathy_100,Nepoui_Extent)

plot(Nepoui_Depth)
contour(Nepoui_Depth,add=TRUE)
plot(DNApoint,add=TRUE)


metaDna$DepthMNT=round(extract(Nepoui_Depth,xy))*(-1)
metaDna[metaDna$Site_name=="Nepoui",] #### les prof sommets ne sont pas super, et les profs pelagique ok

Nepoui_SummitDepth=round(max(values(Nepoui_Depth),na.rm=TRUE))
Nepoui_BottomDepth=round(min(values(Nepoui_Depth),na.rm=TRUE))
Nepoui_Height=Nepoui_SummitDepth-Nepoui_BottomDepth
Nepoui_SummitDepth
Nepoui_BottomDepth
Nepoui_Height   ###### la prof du sommet est positive, je fixe le recifo-lagonnaire à 60 m de fond

values(Nepoui_Depth)[values(Nepoui_Depth) > 0] = NA   ### suppression des terres
#values(Nepoui_Depth)[values(Nepoui_Depth) > -60] = NA   ### suppression des valeurs de profondeur superieures à 60m
...
metaDna$DepthMNT=round(extract(Nepoui_Depth,xy))*(-1)
metaDna[metaDna$Site_name=="Nepoui",] #### les prof sommets sont ok, et les profs pelagique aussi

####SUMMIT. Je fixe le recifo-lagonaire a 60 m pour les sites cotiers. Le lagon est considere comme le summit
Nepoui_Summit_Poly=Nepoui_Depth
values(Nepoui_Summit_Poly)[values(Nepoui_Summit_Poly) < -60] = NA
plot(Nepoui_Summit_Poly)
Nepoui_SummitRugosity=sd(values(Nepoui_Summit_Poly),na.rm=TRUE)
Nepoui_SummitRugosity
values(Nepoui_Summit_Poly)[!is.na(values(Nepoui_Summit_Poly))] <- 1
plot(Nepoui_Summit_Poly)
Nepoui_Summit_Poly=rasterToPolygons(Nepoui_Summit_Poly, dissolve=TRUE)
Nepoui_SummitArea=area(Nepoui_Summit_Poly)*1e-6
Nepoui_SummitArea
plot(Nepoui_Depth)
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)

###SLOPE. Le lagon est fixe a 60m. Le lagon est considere comme le summit
Nepoui_Slope_Poly=Nepoui_Depth
values(Nepoui_Slope_Poly)[values(Nepoui_Slope_Poly) > -60 | values(Nepoui_Slope_Poly) < Nepoui_BottomDepth-30/100*Nepoui_BottomDepth] = NA
plot(Nepoui_Slope_Poly)
values(Nepoui_Slope_Poly)[!is.na(values(Nepoui_Slope_Poly))] <- 1
plot(Nepoui_Slope_Poly)
Nepoui_Slope_Poly=rasterToPolygons(Nepoui_Slope_Poly, dissolve=TRUE)
plot(Nepoui_Depth)
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(DNApoint,add=TRUE)
...
########     Nepoui NIGHT SLOPE ACOUSTIC
plot(Nepoui_Depth)
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_Night[[2]],Nepoui_Slope_Poly),add=TRUE)

Acoustic_Night_Nepoui_Slope=as.data.frame(mask(Acoustic_stack_Night,Nepoui_Slope_Poly),xy=TRUE)
Acoustic_Night_Nepoui_Slope=Acoustic_Night_Nepoui_Slope[rowSums(is.na(Acoustic_Night_Nepoui_Slope)) != ncol(Acoustic_Night_Nepoui_Slope)-2,]
Acoustic_Night_Nepoui_Slope$Site="Nepoui"
Acoustic_Night_Nepoui_Slope$Day="Night"
Acoustic_Night_Nepoui_Slope$Habitat="Slope"

#View(Acoustic_Night_Nepoui_Slope)
head(Acoustic_Night_Nepoui_Slope)
#############


########     Nepoui NIGHT SUMMIT ACOUSTIC
plot(Nepoui_Depth)
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_Night[[2]],Nepoui_Summit_Poly),add=TRUE)

Acoustic_Night_Nepoui_Summit=as.data.frame(mask(Acoustic_stack_Night,Nepoui_Summit_Poly),xy=TRUE)
Acoustic_Night_Nepoui_Summit=Acoustic_Night_Nepoui_Summit[rowSums(is.na(Acoustic_Night_Nepoui_Summit)) != ncol(Acoustic_Night_Nepoui_Summit)-2,]
Acoustic_Night_Nepoui_Summit$Site="Nepoui"
Acoustic_Night_Nepoui_Summit$Day="Night"
Acoustic_Night_Nepoui_Summit$Habitat="Summit"

#View(Acoustic_Night_Nepoui_Summit)
head(Acoustic_Night_Nepoui_Summit)
#############

########     Nepoui DAY SLOPE ACOUSTIC
plot(Nepoui_Depth)
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_day[[2]],Nepoui_Slope_Poly),add=TRUE)

Acoustic_Day_Nepoui_Slope=as.data.frame(mask(Acoustic_stack_day,Nepoui_Slope_Poly),xy=TRUE)
Acoustic_Day_Nepoui_Slope=Acoustic_Day_Nepoui_Slope[rowSums(is.na(Acoustic_Day_Nepoui_Slope)) != ncol(Acoustic_Day_Nepoui_Slope)-2,]
Acoustic_Day_Nepoui_Slope$Site="Nepoui"
Acoustic_Day_Nepoui_Slope$Day="Day"
Acoustic_Day_Nepoui_Slope$Habitat="Slope"

#View(Acoustic_Day_Nepoui_Slope)
head(Acoustic_Day_Nepoui_Slope)
#############

########     Nepoui DAY SUMMIT ACOUSTIC
plot(Nepoui_Depth)
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_day[[2]],Nepoui_Summit_Poly),add=TRUE)

Acoustic_Day_Nepoui_Summit=as.data.frame(mask(Acoustic_stack_day,Nepoui_Summit_Poly),xy=TRUE)
Acoustic_Day_Nepoui_Summit=Acoustic_Day_Nepoui_Summit[rowSums(is.na(Acoustic_Day_Nepoui_Summit)) != ncol(Acoustic_Day_Nepoui_Summit)-2,]
Acoustic_Day_Nepoui_Summit$Site="Nepoui"
Acoustic_Day_Nepoui_Summit$Day="Day"
Acoustic_Day_Nepoui_Summit$Habitat="Summit"

#View(Acoustic_Day_Nepoui_Summit)
head(Acoustic_Day_Nepoui_Summit)
...
Nepoui_Acoustic=rbind(Acoustic_Night_Nepoui_Slope,Acoustic_Night_Nepoui_Summit,Acoustic_Day_Nepoui_Slope,Acoustic_Day_Nepoui_Summit)

#add bathymetric data
Nepoui_Acoustic$SummitDepth=Nepoui_SummitDepth*(-1)
Nepoui_Acoustic$ValleyDepth=Nepoui_BottomDepth*(-1)
Nepoui_Acoustic$Height=Nepoui_Height
Nepoui_Acoustic$SummitAreasKm2=Nepoui_SummitArea
Nepoui_Acoustic$SummitRugosity=Nepoui_SummitRugosity
Nepoui_Acoustic$BottomDepth=extract(Nepoui_Depth,Nepoui_Acoustic[c(1,2)])*(-1)
#View(Nepoui_Acoustic)
head(Nepoui_Acoustic)

# correct bad bottom depth for depth smaller than 800 m (maximum measured by EK60)
#head(Nepoui_Acoustic)
#cbind(names(Nepoui_Acoustic))

Nepoui_Acoustic2=Nepoui_Acoustic[,c(3:81)]
#cbind(names(Nepoui_Acoustic2))
head(Nepoui_Acoustic2)

# affecte une profondeur lorsque mesurable par EK60
for (i in 1:nrow(Nepoui_Acoustic2)) {
  for (p in 1:ncol(Nepoui_Acoustic2)) {
    if (sum(Nepoui_Acoustic2[i,c(p:79)],na.rm = TRUE)==0) {
      Nepoui_Acoustic$BottomDepth[i]=(p-1)*10
      break
    } 
  }
}
...
for (i in 1:nrow(Nepoui_Acoustic2)) {
    if (Nepoui_Acoustic2[i,79]!="NaN" & Nepoui_Acoustic$BottomDepth[i]<790) {
      Nepoui_Acoustic$BottomDepth[i]=mean(Nepoui_Acoustic$BottomDepth[Nepoui_Acoustic$BottomDepth > 790])
      next
  }
}
...
Nepoui_Acoustic$Habitat[Nepoui_Acoustic$BottomDepth<=60]="Summit"
Nepoui_Acoustic$Habitat[Nepoui_Acoustic$BottomDepth> 60 &  
                      Nepoui_Acoustic$BottomDepth<=(Nepoui_BottomDepth-30/100*Nepoui_BottomDepth)*(-1)]="Slope"

# verifie qu'il n'y a aucune profondeur superieure a la limite infeieure de la pente
Nepoui_Acoustic[Nepoui_Acoustic$BottomDepth>(Nepoui_BottomDepth-30/100*Nepoui_BottomDepth)*(-1),]

#sample size for analysis at site
table(Nepoui_Acoustic$Habitat,Nepoui_Acoustic$Day)

# raster layer of surface acoustic data at site
Nepoui_Acoustic_Surface_raster=rasterFromXYZ(cbind(Nepoui_Acoustic$x,Nepoui_Acoustic$y,Nepoui_Acoustic$Depth_10),crs = "+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0")
Nepoui_Acoustic_RealSummit_Surface_raster=rasterFromXYZ(cbind(Nepoui_Acoustic$x[Nepoui_Acoustic$Habitat=="Summit"],Nepoui_Acoustic$y[Nepoui_Acoustic$Habitat=="Summit"],Nepoui_Acoustic$Depth_10[Nepoui_Acoustic$Habitat=="Summit"]),crs = "+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0")
Nepoui_Acoustic_RealSlope_Surface_raster=rasterFromXYZ(cbind(Nepoui_Acoustic$x[Nepoui_Acoustic$Habitat=="Slope"],Nepoui_Acoustic$y[Nepoui_Acoustic$Habitat=="Slope"],Nepoui_Acoustic$Depth_10[Nepoui_Acoustic$Habitat=="Slope"]),crs = "+proj=longlat +datum=WGS84 +no_defs +ellps=WGS84 +towgs84=0,0,0")



# add environmental data
head(Nepoui_Acoustic)
names(Nepoui_Acoustic)
Nepoui_Acoustic$SSTmean1k=extract(SSTmean1k,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$SSTmin1k=extract(SSTmin1k,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$SSTmax1k=extract(SSTmax1k,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$SSTsd1k=extract(SSTsd1k,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$ChlorA=extract(ChlorA,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$EastwardVelocity=extract(EastwardVelocity,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$NorthwardVelocity=extract(NorthwardVelocity,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$Salinity=extract(Salinity,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$SeaFloorPotentialTemperature=extract(SeaFloorPotentialTemperature,Nepoui_Acoustic[c(1,2)])
Nepoui_Acoustic$SuspendedParticulateMatter=extract(SuspendedParticulateMatter,Nepoui_Acoustic[c(1,2)])

Nepoui_pnts=Nepoui_Acoustic[,c(1,2)]
dist.Reef = geosphere::dist2Line(Nepoui_pnts, Reef)
dist.Land = geosphere::dist2Line(Nepoui_pnts, Land)
Nepoui_Acoustic$ShortestDistanceReef=dist.Reef[,1]
Nepoui_Acoustic$ShortestDistanceLand=dist.Land[,1]
...
#surface 0-20m
Nepoui_Acoustic$AcousticSurface=rowMeans(Nepoui_Acoustic[,c(3:4)],na.rm = TRUE)
...
Nepoui_Acoustic2=Nepoui_Acoustic[,c(3:81)]
Nepoui_Acoustic$AcousticFond="NaN"

for (i in 1:nrow(Nepoui_Acoustic2)) {
  for (p in 1:ncol(Nepoui_Acoustic2)) {
    k=p-2+2
    l=p-1+2
    if (sum(Nepoui_Acoustic2[i,c(p:79)],na.rm = TRUE)==0 & k==2) {
      Nepoui_Acoustic$AcousticFond[i]=Nepoui_Acoustic[i,l]
    }else if (sum(Nepoui_Acoustic2[i,c(p:79)],na.rm = TRUE)==0 & k!=2) {
      Nepoui_Acoustic$AcousticFond[i]=rowMeans(Nepoui_Acoustic[i,c(k:l)],na.rm = TRUE)
      break
    }
  }
}
...
names(Nepoui_Acoustic)
head(Nepoui_Acoustic)
unique(Nepoui_Acoustic$Habitat)
unique(Nepoui_Acoustic$Day)
range(as.numeric(Nepoui_Acoustic$AcousticFond),na.rm=TRUE)
range(as.numeric(Nepoui_Acoustic$AcousticSurface),na.rm=TRUE)
table(Nepoui_Acoustic$Day,Nepoui_Acoustic$Habitat)
View(Nepoui_Acoustic)
...
#export directory
dir.exists("Nepoui_Output")
dir.create("Nepoui_Output")

write_xlsx(list(Nepoui = Nepoui_Acoustic),path="Nepoui_Output/Nepoui_Acoustic_Data.xlsx")
writeRaster(Nepoui_Depth, filename="Nepoui_Output/Nepoui_Depth.tif", format="GTiff", overwrite=TRUE)
writeRaster(Nepoui_Acoustic_Surface_raster, filename="Nepoui_Output/Nepoui_Acoustic_Surface_raster.tif", format="GTiff", overwrite=TRUE)

path=getwd()
setwd(paste(path,"/Nepoui_Output",sep=""))
getwd()
writeOGR(Nepoui_Slope_Poly, dsn = '.', layer = 'Nepoui_Slope_Poly', driver = "ESRI Shapefile")
writeOGR(Nepoui_Summit_Poly, dsn = '.', layer = 'Nepoui_Summit_Poly', driver = "ESRI Shapefile")

setwd(path)
getwd()

###### Plot data without showing error in depth summit/slope
plot(Nepoui_Depth,main="Nepoui")
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Acoustic_Surface_raster,col="lavender",add=TRUE,legend=FALSE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)

dev.print(device = png, file = "Nepoui_Output/Nepoui_Map_Acoustic.png", width = 600)
...
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(Nepoui_Acoustic_RealSummit_Surface_raster,col="magenta",add=TRUE,legend=FALSE)
plot(Nepoui_Acoustic_RealSlope_Surface_raster,col="blue",add=TRUE,legend=FALSE)

dev.print(device = png, file = "Nepoui_Output/Nepoui_Map_Acoustic_RealSlopeSummit.png", width = 600)
...
##########MULTIPLOT
par(mfrow=c(2,2))
plot(Nepoui_Depth,main="Night SLope")
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_Night[[2]],Nepoui_Slope_Poly),add=TRUE)

plot(Nepoui_Depth,main="Night Summit")
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_Night[[2]],Nepoui_Summit_Poly),add=TRUE)
...
plot(Nepoui_Depth, main= "Day Slope")
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_day[[2]],Nepoui_Slope_Poly),add=TRUE)

plot(Nepoui_Depth, main = "Day Summit")
contour(Nepoui_Depth,add=TRUE)
plot(Nepoui_Slope_Poly,border="blue",lwd=3,add=TRUE)
plot(Nepoui_Summit_Poly,border="magenta",lwd=3,add=TRUE)
plot(mask(Acoustic_stack_day[[2]],Nepoui_Summit_Poly),add=TRUE)
