...
accumulation_curve_all_samples <- function(x, column_station = "Station", complete_samples,
                                           species_unit = "Species", method_accumulation = "exact"){
...
accumulation_curve_df <- function(x, column_station = "Station", 
                                  species_unit = "Species", method_accumulation = "exact"){
...
asymptote_mm <- function(x, column_station = "Station", 
                         species_unit = "Species", method_accumulation = "exact"){
