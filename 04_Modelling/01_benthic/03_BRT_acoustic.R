...
dir.exists("04_Modelling/01_benthic/BRT_Output")
dir.create("04_Modelling/01_benthic/BRT_Output")

# charger les fonctions BRT necessaires
source("04_Modelling/01_benthic/00_Functions_BRT.R")
...
myPredictor=c("Longitude","Latitude", "Habitat", "SummitDepth", "Height", "SummitAreaKm2", "SummitRugosity","BottomDepth",
              "SSTmean", "SSTmin", "SSTmax", "SSTsd", "Chla", "EastwardVelocity", "NorthwardVelocity",
              "Salinity", "seafloorTemp", "SuspendedParticulateMatter", "ReefMinDist", "LandMinDist",
              "TravelTime")

myPredictorNumeric=c("Longitude","Latitude","SummitDepth", "Height", "SummitAreaKm2", "SummitRugosity","BottomDepth",
                     "SSTmean", "SSTmin", "SSTmax", "SSTsd", "Chla", "EastwardVelocity", "NorthwardVelocity",
                     "Salinity", "seafloorTemp", "SuspendedParticulateMatter", "ReefMinDist", "LandMinDist",
                     "TravelTime")
...
responseName=myResponse # in case there is only one response variable
  ...
  png(paste0("04_Modelling/01_benthic/BRT_Output/", "InteractionPlotsBestModel.png"), width = 1200, height = 600)
  ...
  png(paste0("04_Modelling/01_benthic/BRT_Output/", "InteractionPlotsBestModelDismo.png"), width = 1200, height = 600)
