...
########################################################################################################################################
## Load abundance data
load("03_preliminary_analyses/02_Species_MOTU_selection/bruvs_species_selected.rdata")
...
formula <- as.formula(~ Habitat + BottomDepth + EastwardVelocity + Salinity +  
                        SSTmean + SummitDepth + SummitAreaKm2 + 
...
######################################################################################################################################
#all variables simple
formula <- as.formula(~ Habitat + BottomDepth + I(BottomDepth^2) + EastwardVelocity + I(EastwardVelocity^2) + 
                        Salinity + I(Salinity^2) + SSTmean + I(SSTmean^2)+
                        SummitDepth + I(SummitDepth^2) + SummitAreaKm2 + I(SummitAreaKm2^2) + 
                        SummitRugosity + I(SummitRugosity^2) + TravelTime + I(TravelTime^2) + LandMinDist + I(LandMinDist^2))
...
######################################################################################################################################
#all variables simple
formula <- as.formula(~ SSTmax + I(SSTmax^3) + Habitat + BottomDepth + I(BottomDepth^3) + EastwardVelocity + I(EastwardVelocity^3) + 
                        ReefMinDist + I(ReefMinDist^3) + Salinity + I(Salinity^3) + SuspendedParticulateMatter + I(SuspendedParticulateMatter^3) + 
                        NorthwardVelocity + I(NorthwardVelocity^3) + SSTmean + I(SSTmean^3) + Chla + I(Chla^3) + seafloorTemp + I(seafloorTemp^3) +
                        SummitDepth + I(SummitDepth^3) + SummitAreaKm2 + I(SummitAreaKm2^3) + 
                        SummitRugosity + I(SummitRugosity^3) + TravelTime + I(TravelTime^3) + LandMinDist + I(LandMinDist^3))
