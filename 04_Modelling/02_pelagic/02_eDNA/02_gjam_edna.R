...
save(gjam, file="04_Modelling/02_pelagic/02_eDNA/GJAM_Output_edna/gjam_model.rdata")


sens$variable <- rownames(sens)
sens <- sens[-15,]
sens$variable <- gsub("HabitatDeepSlope", "Habitat", sens$variable)
sens$group <- c(1,1,2,3,3,4,5,5,6,7,7,8,9,10)
...
ggsave(plot_sens, file="04_Modelling/02_pelagic/02_eDNA/GJAM_Output_edna/gjamOutput/plot_sens.png", width=6, height = 5)
...
save(predictions, file="04_Modelling/02_pelagic/02_eDNA/GJAM_Output_edna/predictions.rdata")
