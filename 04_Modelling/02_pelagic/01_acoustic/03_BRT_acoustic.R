...
dir.exists("04_Modelling/02_pelagic/01_acoustic/BRT_Output_acoustic")
dir.create("04_Modelling/02_pelagic/01_acoustic/BRT_Output_acoustic")

# charger les fonctions BRT necessaires
source("04_Modelling/02_pelagic/01_acoustic/00_Functions_BRT.R")
...
responseName=myResponse # in case there is only one response variable
  ...
  png(paste0("04_Modelling/02_pelagic/01_acoustic/BRT_Output_acoustic/", "InteractionPlotsBestModel.png"), width = 1200, height = 600)
  ...
  png(paste0("04_Modelling/02_pelagic/01_acoustic/BRT_Output_acoustic/", "InteractionPlotsBestModelDismo.png"), width = 1200, height = 600)
