...
load("05_Marine_Spatial_Planning/03_Prioritization/Prioritization30/Solution30_blm_1/feature_target30.rdata")
...
ggsave("06_Figures/feature_targets.png", width = 8, height = 5)
